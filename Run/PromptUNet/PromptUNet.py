...
class PromptUNet(nn.Module):
    def __init__(self,device, in_c, out_c, base_c, kernels=[6, 12, 24,48,],attention_kernels=[4,2,4,6], d_model=64,num_prompt_heads=4,num_heads=8,img_size=(512,512),dropout=0.1,batch_norm=False):
        super().__init__()
